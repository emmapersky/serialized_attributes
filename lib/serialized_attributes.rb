module SerializedAttributes
  ...
  module ClassMethods
    ...
    def instantiate(record)
      object = super(record)
      #_with_serialized_attributes(record)
    ...
    def attribute(name, type, opts = {})
      ...
      #write_inheritable_attribute(:serialized_attributes_definition, {}) if serialized_attributes_definition.nil?
